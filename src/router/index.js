  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/Home/workorderstatus',
          name: '工单详情',
          component: resolve => require(['../pages/workorderpage/workorderstatus.vue'], resolve)
        },
        {
          path: '/Home/workupdate',
          name: '工单编辑',
        ...
        {
          path: '/Home/supplier/updatevendor',
          name: '供应商详情',
          component: resolve => require(['../pages/supplier/updatevendor.vue'], resolve)
        }
      ]
    }
  ]
